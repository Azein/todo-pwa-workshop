    ...
    return (
      <div className="todo">
        ...
        <span
          className={[
            "todoText",
            this.props.todo.completed ? "todoChecked" : ""
          ].join(" ")}
        >
    ...
    {props.login && (
      <div className="icons">
        ...
        >
          <use
            xlinkHref={
              "/img/feather-sprite.svg#bell" + (props.subscribed ? "" : "-off")
            }
          />
        </svg>
        <svg
    ...
    return (
      <div className="loginScreen">
        ...
        <div className="loginControls">
          ...
          <svg
            className="feather right-arrow login-button"
            aria-label="Login"
            role="button"
            onClick={() =>
...
class Content extends React.Component {
  ...
  addTodo(text) {
    this.getLatestTodos().then(todos => {
      this.postTodos([
        ...todos,
        { title: text, completed: false, id: todos.length + 1 }
      ]);
    });
    ...
    return (
      <div className="content">
        ...
        <div className="newTodo">
          ...
          <svg
            className="feather right-arrow"
            aria-label="Add new todo"
            role="button"
            onClick={() =>
              this.addTodo(document.getElementById("todoText").value)
            }
          >
            <use xlinkHref="/img/feather-sprite.svg#arrow-right-circle" />
          </svg>
    ...
    return (
      <div className="app">
        <Header
          ...
          subscribe={this.subscribeUser.bind(this)}
          unsubscribe={this.unsubscribeUser.bind(this)}
